...
FusionCharts.register('module', ['private', 'modules.renderer.js-widgets', function () {
    ...
    chartAPI('angulargauge', {
        ...
        updateSnapPoints: function(hc) {
            ...
            snaps.chartcenterx = hc.chart.origW / 2;
            snaps.chartcentery = hc.chart.origH / 2;
            snaps.gaugecenterx = series.gaugeOriginX;
            snaps.gaugecentery = series.gaugeOriginY;
        ...
        point : function (chartName, series, data, FCChartObj, HCObj) {
            ...
            if (hasValidPoint) {
                ...
                if (!isPyramid && !streamlinedData) {
                    ...
                    /*
                     * These values are generally blank or undefined as there is no specific attributes
                     * to configure the sum value that gets applied only when streamLineData attribute is
                     * false.
                     */
                    series.data.push({
