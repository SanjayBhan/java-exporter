...
public class ExportConfiguration {
  ...
  // like "/home/suvradipsaha/NetBeansProjects/fc-exporter/build/web/testMe"
	...
	/*
	 * -------------Path of Export Resources---------------------------
	 * INKSCAPE_PATH is to set the PATH of INKSCAPE
	 * IMAGEMAGICK_PATH is to set the PATH of IMAGEMAGICK
	 */
	...
	public static void loadProperties() {
		...
		try {
			...
			FILESUFFIXFORMAT = props.getProperty("FILESUFFIXFORMAT",
					FILESUFFIXFORMAT);
			IMAGEMAGICK_PATH = props.getProperty("IMAGEMAGICK_PATH",
					IMAGEMAGICK_PATH);
